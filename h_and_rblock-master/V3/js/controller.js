...
function bindEvents(){
    ...
    document.querySelector("#update").addEventListener("click",addItem);
    
}

function sortItem(){
    itemOperations.sortItem();
    printTable();
}


function clearText(){
    var types=["id","desc","name","price","color","date","url"];
...
function edit(){
    var currentRow =itemOperations.searchById(this.getAttribute("item-id"));
    console.log(currentRow);
    var types=["id","desc","name","price","color","date","url"];
    for(var type of types){
        console.log(type);
    document.querySelector("#"+type).value=currentRow[type];
    }
